...
public record StatusBarDto(int CameraIndex, int BufferSize, bool IsConnected, string StatusMessage, string RecordingError);
...
public class CreateStatusBarDto : Transform<Tuple<int, int, bool, string, string>, StatusBarDto>
{
    /// <summary>
    ...
    public override IObservable<StatusBarDto> Process(IObservable<Tuple<int, int, bool, string, string>> source)
    {
