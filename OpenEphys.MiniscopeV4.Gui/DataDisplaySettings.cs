...
public record DataDisplaySettings(int BufferSize, SaturationSettings Saturation, DffSettings Dff);
...
public class CreateDataDisplaySettings
{
        ...
        IObservable<DffSettings> dff)
    {
        return Observable.CombineLatest(
            ...
            saturation,
            dff,
            (bufferSize, saturation, dff) => new DataDisplaySettings(bufferSize, saturation, dff));
    }
}
